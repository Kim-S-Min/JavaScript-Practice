...
const ingr = veges.concat(sources); //  veges 배열에 sources 배열을 연결 새 배열을 만든다
...
console.log("STACK: ", fruits.shift()); //  맨 첫번째 요소를 추출 후 제거
console.log("STACK: ", fruits.shift());
console.log("STACK: ", fruits.shift());
console.log("QUEUE: ", fruits);
