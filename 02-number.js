...
let n3 = 3.567;
//  round: 반올림, floor: 버림
console.log(n3, "=>", Math.round(n3), ", ", Math.trunc(3.567), ", ", Math.floor(n3));
...
console.log(parseInt("011", 2));    //  011 -> 2진수 진법 변환 int로 변환
...
console.log(n4, "is", typeof n4);   //  NaN -> number형 이지만, 산술 연산이 불가한 수치
...
//  Infinity가 포함된 산술식은 항상 Infinity이다
console.log(result + 10); 
//  어떤 number 객체가 산술연산 가능한 데이터인지 확인 isFinite() 함수 사용
console.log(result, "is finite", isFinite(rseult));