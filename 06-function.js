//  함수 선언문: function
function sum(a, b) {    //  매개 변수 a, b를 받아서
    return a + b;   //  결과를 반환 한다 -> return 문을 만나면 함수는 종료
}
...
//  익명 함수의 활용 1. 즉시 실행 함수 -> 주로 페이지의 초기화를 할 때 유용하게 사용한다
let initText;
(function(number) {
    ...
    console.log(`매개변수 ${number}를 이용해서 즉시 실했습니다.`);
})(5);

//  console.log("textList:", textList); //  textList는 함수 내부에 있어서
//  외부에서 참조가 불가능하다 -> Error
...
const f2Arrow = (name) => "Hello, " + name; //  매개변수가 있는 화살표 함수
