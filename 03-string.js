...
//  문자열 추출 메서드, 인덱스를 이용하여 내용에 접근
console.log(s1);
console.log("7th char: ", s1.charAt(7));    //  7번 인덱스의 글자
//  그 자체로 배열처럼 접근할 수 있다
console.log("7th char: ", s1[7]);
console.log(s1.substr(7, 10));  //  7번 인덱스 ~ 10글자
console.log(s1.substr(7));      //  7번 부터 끝까지
console.log(s1.substring(7,17)); //  7번 인덱스 부터 16번 인덱스 까지(17은 제외)
console.log(s1.substring(7));   //  7번 인덱스~ 끝까지 출력    
...
console.log("뒤쪽으로부터의 검색: ", s1.lastIndexOf("Script")); //  뒤로부터 검색 후 정인덱스
...
//  템플릿 문자열
console.log("=========== Temlate String");
let temp = 24;
//  현재 실내 온도는 24도 입니다.

//  ES5 방식
message = "현내 실내 온도는 " + temp + "도 입니다.";
